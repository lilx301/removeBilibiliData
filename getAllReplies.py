...
# 上次最新时间戳
    ...
    while 1:
        ...
        if viewAtStr is not None and len(viewAtStr) > 0:
            ...
            if timeLst is not None and timeLst < oldestTime - 6  *  3600:
                print("早于观看时间的评论忽略吧22...")
                break
        else:
            if timeLst is not None and historyItem.get('view_at') is not None and timeLst < historyItem.get('view_at') - 6  *  3600:
                print("早于观看时间的评论忽略吧...")
                break
